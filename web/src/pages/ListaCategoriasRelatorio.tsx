...
// Componente de relatório que lista todas as categorias com somatórios de receitas, despesas e saldo.
export function ListaCategoriasRelatorio() {
  ...
  // Carrega as categorias e transações em paralelo.
  useEffect(() => {
  ...
  // Filtra as transações por categoria e calcula o total acumulado de receitas e despesas.
  ...
  // Somatório financeiro de todas as categorias cadastradas.
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 text-left animate-in fade-in duration-500">
      <div className="flex items-center gap-4">
        <button
          onClick={() => navigate("/totais")}
          className="bg-white p-3 rounded-xl shadow-sm hover:bg-gray-50 border border-gray-100 font-bold"
        >
          ←
        </button>
      ...
      {/* Grid de cards exibindo o resumo financeiro individual de cada categoria. */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {currentItems.map((c) => {
          const fin = Number(c.finalidade);
          const labelFinalidade =
            fin === 2 ? "Receita" : fin === 1 ? "Despesa" : "Ambas";
            ...
            >
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <span
                      className={`w-1.5 h-1.5 rounded-full ${fin === 2 ? "bg-green-500" : fin === 1 ? "bg-red-500" : "bg-blue-500"}`}
                    ></span>
                ...
                <span className="text-green-500 font-black text-xs opacity-0 group-hover:opacity-100 transition-all">
                  VER →
                </span>
              </div>

              {/* Subtotal financeiro por categoria: receitas, despesas e o saldo líquido. */}
              <div className="grid grid-cols-3 gap-2 pt-2 border-t border-gray-50">
                ...
                <div className="text-center">
                  ...
                  <p
                    className={`text-[10px] font-black ${saldo >= 0 ? "text-blue-600" : "text-red-600"}`}
                  >
                    R$ {saldo.toFixed(2)}
                  </p>
                </div>
        ...
        <div className="flex justify-between items-center bg-gray-50/50 p-4 rounded-2xl border border-gray-100">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="px-4 py-2 bg-white rounded-lg border text-xs font-black disabled:opacity-30"
            >
              Anterior
            </button>
            <button
      ...
      {/* Painel que apresenta o balanço financeiro total de todas as categorias. */}
      <div className="mt-12 bg-gray-900 p-8 rounded-[2.5rem] shadow-2xl shadow-green-900/20 text-white relative overflow-hidden">
        <div className="absolute top-0 right-0 p-8 opacity-10 text-9xl font-black text-green-500">
          📊
        </div>
        <h2 className="text-xs font-black uppercase tracking-[0.3em] mb-6 text-green-400">
          Balanço Geral por Categorias
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
          ...
          <div>
            ...
            <p
              className={`text-3xl font-black ${saldoLiquidoGeral >= 0 ? "text-blue-400" : "text-red-400"}`}
            >
