      ...
      <div className="min-h-screen font-sans">
        ...
        <nav className="bg-white shadow-sm border-b border-gray-100 px-4 py-4 mb-8">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            >
              <span className="bg-blue-600 text-white p-2 rounded-lg text-sm">
                CG
              </span>
            ...
            <div className="flex items-center gap-6 font-bold text-gray-500 text-sm uppercase tracking-tighter">
              ...
              <Link
                to="/totais"
                className="bg-gray-900 text-white px-4 py-2 rounded-xl hover:bg-blue-600 transition-all flex items-center gap-2"
              >
                📊 Relatórios
              </Link>
            </div>
        ...
        <main className="max-w-6xl mx-auto px-4 pb-20">
          <Routes>
            ...
            <Route
              path="/relatorios/lista-pessoas"
              element={<ListaPessoasRelatorio />}
            />
            <Route path="/relatorios/pessoa/:id" element={<DetalhePessoa />} />
            <Route
              path="/relatorios/lista-categorias"
              element={<ListaCategoriasRelatorio />}
            />
            <Route
              path="/relatorios/categoria/:id"
              ...
              element={
                <div className="text-center py-32 bg-white rounded-[3rem] shadow-xl shadow-gray-200/50 border border-gray-100">
                  ...
                  <p className="text-gray-400 text-lg max-w-md mx-auto">
                    Monitore seus gastos residenciais e de sua família em um só
                    lugar com relatórios detalhados.
                  </p>
                  <div className="mt-10 flex justify-center gap-4">
                    <Link
                      to="/transacoes"
                      className="bg-blue-600 text-white font-black px-8 py-4 rounded-2xl shadow-lg shadow-blue-200 hover:scale-105 transition-transform"
                    >
                      Lançar Agora
                    </Link>
                  </div>
